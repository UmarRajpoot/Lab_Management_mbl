...
import ConnectivitySVG from './Src/Components/ConnectivitySVG';
import SoftwareSVG from './Src/Components/SoftwareSVG';
...
const App = () => {
  ...
  const [socket_port, set_socket_port] = useState('');
        ...
        <ScrollView
          ...
          <Box
            ...
            <Text style={{color: 'black', fontSize: 20, marginTop: 5}}>
              {!ClientConnected ? 'Put Your Software IP' : 'Manage your System'}
            </Text>
          </Box>
          {!ClientConnected ? (
            <Box>
                ...
                <TextInput
                  ...
                  onBlur={() => {
                    ...
                    if (input_error.port === true) {
                      setErrorPORTText('Incorrect Port. Must be 4 character.');
                    } else {
                      setErrorPORTText(null);
                    }
                  }}
            ...
            <Box
              ...
              <TouchableOpacity
                ...
                <Image
                  source={require('./Src/Constants/shut.png')}
